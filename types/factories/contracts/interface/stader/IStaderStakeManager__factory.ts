...
import type {
  IStaderStakeManager,
  IStaderStakeManagerInterface,
} from "../../../../contracts/interface/stader/IStaderStakeManager";
    ...
    outputs: [
      {
        ...
        internalType: "struct IStaderStakeManager.BotDelegateRequest",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct IStaderStakeManager.BotUndelegateRequest",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct IStaderStakeManager.WithdrawalRequest[]",
        name: "",
        type: "tuple[]",
      },
    ],
...
export class IStaderStakeManager__factory {
  static readonly abi = _abi;
  static createInterface(): IStaderStakeManagerInterface {
    return new Interface(_abi) as IStaderStakeManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IStaderStakeManager;
  }
}
