...
export interface GangStakingV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface GangStakingV2 extends BaseContract {
  connect(runner?: ContractRunner | null): GangStakingV2;
  waitForDeployment(): Promise<this>;

  interface: GangStakingV2Interface;
