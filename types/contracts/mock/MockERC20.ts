...
export interface MockERC20Interface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "setVToken", data: BytesLike): Result;
...
export interface MockERC20 extends BaseContract {
  ...
  setVToken: TypedContractMethod<[_vToken: AddressLike], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "setVToken"
  ): TypedContractMethod<[_vToken: AddressLike], [void], "nonpayable">;
  getFunction(
