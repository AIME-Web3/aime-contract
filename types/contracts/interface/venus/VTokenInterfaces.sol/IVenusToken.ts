...
export interface IVenusTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_acceptAdmin"
      | "_addReserves"
...
export interface IVenusToken extends BaseContract {
  connect(runner?: ContractRunner | null): IVenusToken;
  waitForDeployment(): Promise<this>;

  interface: IVenusTokenInterface;
